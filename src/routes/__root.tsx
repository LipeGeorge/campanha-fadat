...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Comece sua missão: descubra o curso ideal na FADAT em uma experiência interativa e gamificada. Vestibular FADAT 2027.1." },
      { name: "author", content: "FADAT Educação Superior" },
      { property: "og:title", content: "FADAT Station 2027.1 — Comece sua missão" },
      { property: "og:description", content: "Uma experiência gamificada para descobrir seu futuro na FADAT. Pré-inscrição Vestibular 2027.1." },
